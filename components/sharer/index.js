...
//		}
	...
	return(
		<div className="row justify-content-center" style={{textAlign: "center"}}>
	      ...
	      <span className="col cursorHover" data-bs-toggle="tooltip" data-bs-placement="top" title="share via facebook"> 
	      ...
	      <span className="col cursorHover" data-bs-toggle="tooltip" data-bs-placement="top" title="share via whatsapp">
	      ...
	      <span className="col cursorHover" data-bs-toggle="tooltip" data-bs-placement="top" title="share via twitter">
	      ...
	      {
	      	linkCopied ? 
	      		<span className="col cursorHover" data-bs-toggle="tooltip" data-bs-placement="top" title="link copied">
			     ...
			     :
			     	<span className="col cursorHover" data-bs-toggle="tooltip" data-bs-placement="top" title="copy link"  onClick={()=>copyToClipboard()}>
