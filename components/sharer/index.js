...
export default function ShareWindow(){
	...
	return(
		<div className="flexor">
	      ...
	      <Link href={"mailto:?subject=I found an app to help you learn the maritime flags conviniently" + pretextToShare + url} passHref>
	      <span className="cursorHover" data-bs-toggle="tooltip" data-bs-placement="top" title="share via email">
